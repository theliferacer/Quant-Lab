...
2. **Control Variate (Orange)**: Results in a significantly narrower, more stable distribution centered around the mean, representing a much higher "precision-to-computation" ratio
